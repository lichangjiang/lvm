...
if [ ! -d "/flexmnt/$driver_dir" ]; then
  echo "mkdir /flexmnt/$driver_dir"
  mkdir "/flexmnt/$driver_dir"
fi

tmp_driver=.tmp_$DRIVER
cp "/$DRIVER" "/flexmnt/$driver_dir/$tmp_driver"
echo "cp /$DRIVER /flexmnt/$driver_dir/$tmp_driver with result code $?"

mv -f "/flexmnt/$driver_dir/$tmp_driver" "/flexmnt/$driver_dir/$DRIVER"
echo "mv -f /flexmnt/$driver_dir/$tmp_driver /flexmnt/$driver_dir/$DRIVER with result code $?"
